...
import { CheckCircle2, Package, Calendar, MapPin, Phone, User, Loader2 } from "lucide-react";
    ...
    return (
      <main className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-6">
           ...
           <h1 className="text-2xl font-serif">Curating your order confirmation...</h1>
           <p className="text-neutral-500 uppercase tracking-widest text-xs">A moment of luxury takes time</p>
        </div>
      </main>
    );
  }
    ...
    return (
      <main className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center space-y-6">
           ...
           <p className="text-neutral-500 uppercase tracking-widest text-xs">We couldn't retrieve your curation details</p>
           <Link href="/shop" className="text-primary border-b border-primary pb-1 uppercase tracking-widest text-xs">Return to Collection</Link>
        </div>
      </main>
    );
  }
